...
from .views import HomePageView, ArticleView, ArticleDetailView, ReviewsView, ContactView, ProjectView, ProjectDetailView, Work_ExampleDetailView, Work_Example_In_ProjectDetailView
